...
<main style={{margin:'3rem 0rem'}}>
  <div class="container" >
    <div class="row">
      ...
      <div class="col-md-6 align-self-center"> <h1 className='font5'>404 Page Not Found</h1> <h2 className='font1'>UH OH! You're lost.</h2>
       
      
        <p className='font6'>The page you are looking for does not exist.
          How you got here is a mystery. But you can click the button below
          to go back to the homepage.
        </p>
        <button onClick={(e)=>{e.preventDefault(); window.location.replace(`/`)}} class="myclass  " style={{border:'none',color:'white',padding:"7px 17px",fontWeight:'bold'}} >HOME</button>
      </div>
    </div>
  </div>
</main>
