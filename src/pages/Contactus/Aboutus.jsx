      ...
      <div className="row" style={{width:"fit-contnt",margin:"auto"}}>
        <div className="col-lg-12">
          <div className="owl-service-item owl-carousel">
            ...
            <div className="item">
              <div className="icon">
                <img style={{width:"100%",overflow:'hidden'}}src={page1} alt=""/>
              </div>
            ...
            <div className="item">
              <div className="icon">
                <img style={{width:"100%",overflow:'hidden'}}src={page2} alt=""/>
              </div>
              <div className="down-content">
                <h4>Best Teachers</h4>
                <p>Suspendisse tempor mauris a sem elementum bibendum. Praesent facilisis massa non vestibulum.</p>
            ...
            <div className="item">
              <div className="icon">
                <img style={{width:"100%",overflow:'hidden'}}src={page3} alt=""/>
              </div>
              <div className="down-content">
                <h4>Best Students</h4>
                <p>Suspendisse tempor mauris a sem elementum bibendum. Praesent facilisis massa non vestibulum.</p>
            ...
            <div className="item">
              <div className="icon">
                <img style={{width:"100%",overflow:'hidden'}}src={image4} alt=""/>
              </div>
              <div className="down-content">
            ...
            <div className="item">
              <div className="icon">
                <img style={{width:"100%",overflow:'hidden'}}src={service} alt=""/>
              </div>
              <div className="down-content">
            ...
            <div className="col-lg-6"  style={{margin:'auto'}} >
              <div className="meeting-item">
                <div className="thumb">
                  ...
                  <a href="meeting-details.html"><img style={{width:"100%",overflow:'hidden'}}src={meeting} alt="New Lecturer Meeting"/></a>
                </div>
                <div className="down-content">
                  <div className="date">
            ...
            <div className="col-lg-6">
              <div className="meeting-item">
                <div className="thumb">
                  ...
                  <a href="meeting-details.html"><img style={{width:"100%",overflow:'hidden'}}src={meeting} alt="Online Teaching"/></a>
                </div>
                <div className="down-content">
                  <div className="date">
            ...
            <div className="col-lg-6">
              <div className="meeting-item">
                <div className="thumb">
                  ...
                  <a href="meeting-details.html"><img style={{width:"100%",overflow:'hidden'}}src={meeting} alt="Higher Education"/></a>
                </div>
                <div className="down-content">
                  <div className="date">
            ...
            <div className="col-lg-6">
              <div className="meeting-item">
                <div className="thumb">
                  ...
                  <a href="meeting-details.html"><img style={{width:"100%",overflow:'hidden'}}src={meeting} alt="Student Training"/></a>
                </div>
                <div className="down-content">
                  <div className="date">
      ...
      <div className="row"  style={{width:'fit-content',margin:"auto"}}  >
        ...
        <div className="col-lg-12">
          <div className="owl-courses-item owl-carousel">
            <div className="item">
              <img style={{width:"100%",overflow:'hidden'}}src={course} alt="Course One"/>
              <div className="down-content">
            ...
            <div className="item">
              <img style={{width:"100%",overflow:'hidden'}}src={course} alt="Course Two"/>
              <div className="down-content">
            ...
            <div className="item">
              <img style={{width:"100%",overflow:'hidden'}}src={course} alt=""/>
              <div className="down-content">
  ...
  <section className="our-facts">
    <div className="container">
      <div className="row" style={{width:'fit-content',margin:"auto"}} >
        ...
        <div className="col-lg-6 align-self-center">
          <div className="video">
            <a href="https://www.youtube.com/watch?v=HndV87XpkWg" target="_blank"><img style={{width:"100%",overflow:'hidden'}}src={play} alt=""/></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="container">
            <nav className="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                <a href="index.html" className="navbar-brand">
                    <h1 className="m-0 text-uppercase golden"><i className="fa fa-clinic-medical me-2"></i>Medinova</h1>
                </a>
        ...
        <div className="container  ">
            <div className="row ">
                <div className="col-lg-5 col-md-12  col-sm-12 mb-5 mb-lg-0"  >
                    ...
                    <img style={{width:"100%",overflow:'hidden',objectFit: "cover"}} className="img-fluid rounded mb-5" src={ppp} />

                     </div>
                </div>
                <div className="col-lg-7 col-md-12  col-sm-12 " >
                    <div className="mb-4 ">
                        <h5 className="d-inline-block   text-uppercase border-bottom border-5">Who are we?</h5>
                    ...
                    <div className="row g-3 pt-3">
                        <div className="col-sm-3 col-6">
                            <div className="golden2 text-center rounded-circle py-4">
                                ...
                                <h6 className="mb-0">Qualified<small className="d-block golden">Doctors</small></h6>
                            </div>
                        </div>
                        <div className="col-sm-3 col-6">
                            <div className="golden2 text-center rounded-circle py-4">
                                <i className="fa fa-3x fa-procedures golden mb-3"></i>
                                <h6 className="mb-0">Emergency<small className="d-block golden">Services</small></h6>
                            </div>
                        </div>
                        <div className="col-sm-3 col-6">
                            <div className="golden2 text-center rounded-circle py-4">
                                <i className="fa fa-3x fa-microscope golden mb-3"></i>
                                <h6 className="mb-0">Accurate<small className="d-block golden">Testing</small></h6>
                            </div>
                        </div>
                        <div className="col-sm-3 col-6">
                            <div className="golden2 text-center rounded-circle py-4">
                                <i className="fa fa-3x fa-ambulance golden mb-3"></i>
                                <h6 className="mb-0">Free<small className="d-block golden">Ambulance</small></h6>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div className="container-fluid py-4">
        <div className="container">
            <div className="text-center mx-auto mb-5"  >
                <h5 className="d-inline-block golden text-uppercase border-bottom border-5">Our Doctors</h5>
           ...
           <div className="team-item">
                    <div className="row g-0 golden2 rounded overflow-hidden">
                        <div className="col-12 col-sm-5 py-4">
                            <img style={{width:"100%",overflow:'hidden',objectFit: "cover"}}className="img-fluid rounded " src={ppp} 
                        ...
                        <div className="col-12 col-sm-7  d-flex flex-column">
                            <div className="mt-auto p-4">
                                ...
                                <h6 className="fw-normal fst-italic golden mb-4"> Heart and blood </h6>
                                <p className="m-0">As SVP, Product at Dotdash Meredith, Keith is responsible for product management of Dotdash's financial brands (Investopedia and The Balance) as well as its performance marketing teams whose work spans the entire Dotdash Meredith publishing family. Keith has been with Dotdash Meredith since 2019. Previous to Dotdash Meredith, Keith was Director of Product Management at Red Ventures, having spent seven years working in various product roles at Bankrate.com. Before working at Bankrate, Keith was the first member of the product team at Hearst Newspapers.

</p>
                                </div>
                            <div className="d-flex mt-auto border-top p-4">
                                <a className="btn btn-lg golden4 btn-lg-square rounded-circle me-3" href="#"><i className="fab fa-twitter"></i></a>
                                <a className="btn btn-lg golden4 btn-lg-square rounded-circle me-3" href="#"><i className="fab fa-facebook-f"></i></a>
                                <a className="btn btn-lg golden4 btn-lg-square rounded-circle" href="#"><i className="fab fa-linkedin-in"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className="container py-5">
            <div className="row g-5">
                <div className="col-lg-3 col-md-6">
                    <h4 className="d-inline-block golden text-uppercase border-bottom border-5 border-secondary mb-4">Get In Touch</h4>
                    <p className="mb-4">No dolore ipsum accusam no lorem. Invidunt sed clita kasd clita et et dolor sed dolor</p>
                    <p className="mb-2"><i className="fa fa-map-marker-alt golden me-3"></i>123 Street, New York, USA</p>
                    <p className="mb-2"><i className="fa fa-envelope golden me-3"></i>info@example.com</p>
                    <p className="mb-0"><i className="fa fa-phone-alt golden me-3"></i>+012 345 67890</p>
                </div>
                <div className="col-lg-3 col-md-6">
                    <h4 className="d-inline-block golden text-uppercase border-bottom border-5 border-secondary mb-4">Quick Links</h4>
                ...
                <div className="col-lg-3 col-md-6">
                    <h4 className="d-inline-block golden text-uppercase border-bottom border-5 border-secondary mb-4">Popular Links</h4>
                    <div className="d-flex flex-column justify-content-start">
                        <a className="text-light mb-2" href="#"><i className="fa fa-angle-right me-2"></i>Home</a>
                        <a className="text-light mb-2" href="#"><i className="fa fa-angle-right me-2"></i>About Us</a>
                        <a className="text-light mb-2" href="#"><i className="fa fa-angle-right me-2"></i>Our Services</a>
                ...
                <div className="col-lg-3 col-md-6">
                    <h4 className="d-inline-block golden text-uppercase border-bottom border-5 border-secondary mb-4">Newsletter</h4>
                    <form action="">
                        <div className="input-group">
                    ...
                    <div className="d-flex">
                        <a className="btn btn-lg golden4 btn-lg-square rounded-circle me-2" href="#"><i className="fab fa-twitter"></i></a>
                        <a className="btn btn-lg golden4 btn-lg-square rounded-circle me-2" href="#"><i className="fab fa-facebook-f"></i></a>
                        <a className="btn btn-lg golden4 btn-lg-square rounded-circle me-2" href="#"><i className="fab fa-linkedin-in"></i></a>
                        <a className="btn btn-lg golden4 btn-lg-square rounded-circle" href="#"><i className="fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="container">
            <div className="row g-5">
                <div className="col-md-6 text-center text-md-start">
                    <p className="mb-md-0">&copy; <a className="golden" href="#">Your Site Name</a>. All Rights Reserved.</p>
                </div>
                <div className="col-md-6 text-center text-md-end">
                    <p className="mb-0">Designed by <a className="golden" href="https://htmlcodex.com">HTML Codex</a></p>
                </div>
            </div>
        </div>
    </div>
    
    <a href="#" className="btn btn-lg golden4 btn-lg-square back-to-top"><i className="bi bi-arrow-up"></i></a>
                ...
                <div className="col-lg-4 templatemo-item-col all soon">
                  <div className="meeting-item">
                    <div className="thumb">
                      ...
                      <a href="meeting-details.html"><img src={meeting} alt=""/></a>
                    </div>
                    <div className="down-content">
                      <div className="date">
